...
id = "navItem2" > Explore Menu < /a> <
    a class = "nav-link"
href = "#deliveryPaymentSection"
id = "navItem3" > Delivery & Payment < /a> <
    a class = "nav-link"
href = "#followUsSection"
id = "navItem4" > Follow Us < /a> <
    /div> <
    /div> <
    /div> <
    /nav> <
...
available
for you.Get live tracking and locate your food on a
...
class = "payment-card-img" / >
    ...
    Thank you
for being a valuable customer to us. <
    /h1> <
...
id = "exampleModalLabel" > Gift voucher < /h5> <
    button type = "button"
class = "close"
data - dismiss = "modal"
aria - label = "Close" >
